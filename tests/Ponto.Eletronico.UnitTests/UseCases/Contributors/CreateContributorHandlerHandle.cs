...
using Ponto.Eletronico.Core.ContributorAggregate;
using Ponto.Eletronico.UseCases.Contributors.Create;
using FluentAssertions;
using NSubstitute;
using Xunit;

namespace Ponto.Eletronico.UnitTests.UseCases.Contributors;
