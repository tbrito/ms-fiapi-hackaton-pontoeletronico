...
using Ponto.Eletronico.Core.ProjectAggregate;
using Ponto.Eletronico.Core.Services;
using Ponto.Eletronico.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Ponto.Eletronico.UnitTests.Core.Services
{
